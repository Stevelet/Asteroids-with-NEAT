...
public class Species {
    ...
    double excessCoeff = 1.5;
    double weightDiffCoeff = 0.8;
    double compatibilityThreshold = 1;
    //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    //empty constructor
    ...
    boolean sameSpecies(Genome g) {
        ...
        double largeGenomeNormaliser = 1;//g.genes.size();
    ...
    Player selectPlayer() {
        ...
        double rand = Random.random(fitnessSum);
        double runningSum = 0;
